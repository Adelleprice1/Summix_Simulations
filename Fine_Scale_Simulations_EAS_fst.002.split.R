...
write.table(finalframe, file="Fine_Scale_Simulations_EAS_fst.002.parameter1.text", sep="\t", quote = FALSE, row.names=F,col.names=T)
...
write.table(finalframe, file="Fine_Scale_Simulations_EAS_fst.002.parameter2.text", sep="\t", quote = FALSE, row.names=F,col.names=T)
...
write.table(finalframe, file="Fine_Scale_Simulations_EAS_fst.002.parameter3.text", sep="\t", quote = FALSE, row.names=F,col.names=T)